...
public class States {
	...
	public static class S0 extends State{
		...
		private Exercise6D controller;
		
		public S0(Exercise6D controller) {
			super("S0");
	...
	public static class S1 extends State{
		...
		public S1(Exercise6D controller) {
			super("S1");
			this.controller = controller;
		}
	...
	public static class S2 extends State{
		...
		public S2(Exercise6D controller) {
			super("S2");
			this.controller = controller;
		}
	...
	public static class S3 extends State{
		...
		public S3(Exercise6D controller) {
			super("S3");
			this.controller = controller;
		}
	...
	public static class S4 extends State{
		...
		public S4(Exercise6D controller) {
			super("S4");
			this.controller = controller;
		}
	...
	public static class S5 extends State{
		...
		public S5(Exercise6D controller) {
			super("S5");
			this.controller = controller;
		}

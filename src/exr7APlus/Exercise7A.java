 ...
 * 
 */
public class Exercise7A extends GameController implements KeyListener, StateChangeListener {
	 ...
	 * @param size
	 */
	public Exercise7A(int rate, Dimension size) {
		super(rate, size);
		// TODO Auto-generated constructor stub
	}
...
//		barr6.setVisible(true);
		...
		fsm = new FSM<>(new State[] { s0, s1, s2, s3, s4, s5, s6 }, // States
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new Exercise7A());
	}
